...
#include "gazebo_ros_planar_movez.h"

namespace gazebo 
{

  GazeboRosPlanarMovez::GazeboRosPlanarMovez() {}

  GazeboRosPlanarMovez::~GazeboRosPlanarMovez() {}

  // Load the controller
  void GazeboRosPlanarMovez::Load(physics::ModelPtr parent, 
      sdf::ElementPtr sdf) 
  {
    ...
    ros::SubscribeOptions so =
      ros::SubscribeOptions::create<geometry_msgs::Twist>(command_topic_, 1,
          boost::bind(&GazeboRosPlanarMovez::cmdVelCallback, this, _1),
          ros::VoidPtr(), &queue_);
    ...
    callback_queue_thread_ = 
      boost::thread(boost::bind(&GazeboRosPlanarMovez::QueueThread, this));

    // listen to the update event (broadcast every simulation iteration)
    update_connection_ = 
      event::Events::ConnectWorldUpdateBegin(
          boost::bind(&GazeboRosPlanarMovez::UpdateChild, this));

  }

  // Update the controller
  void GazeboRosPlanarMovez::UpdateChild() 
  {
  ...
  void GazeboRosPlanarMovez::FiniChild() {
    alive_ = false;
    queue_.clear();
    queue_.disable();
    rosnode_->shutdown();
  ...
  void GazeboRosPlanarMovez::cmdVelCallback(
  ...
  void GazeboRosPlanarMovez::QueueThread() 
  {
  ...
  void GazeboRosPlanarMovez::publishOdometry(double step_time) 
  {
  ...
  GZ_REGISTER_MODEL_PLUGIN(GazeboRosPlanarMovez)
}